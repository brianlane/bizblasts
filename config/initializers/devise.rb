...
Devise.setup do |config|
  ...
  config.secret_key = ENV["SECRET_KEY_BASE"] || Rails.application.config.secret_key_base
  ...
  # 
  # Explicitly enable CSRF token cleanup for security (this is the default)
  # but our custom Admin::SessionsController handles cross-session scenarios
  ...
  # 
  # Use Rails credentials for the pepper, or don't set it to rely on secret_key_base
