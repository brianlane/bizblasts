...
# Only configure if ALL required environment variables are present to allow test environment
# fallback values (needed for CI environments like Dependabot PRs without secrets).
