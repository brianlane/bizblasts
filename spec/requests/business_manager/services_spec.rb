...
RSpec.describe "/manage/services", type: :request do
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get "/manage/services", params: {}, headers: {}, env: { 'HTTP_HOST' => host_params[:host] }
  ...
  describe "GET /new" do
    it "renders a successful response" do
      ...
      get "/manage/services/new", params: {}, headers: {}, env: { 'HTTP_HOST' => host_params[:host] }
      expect(response).to be_successful
    end
  end
  ...
  describe "GET /edit" do
    it "renders a successful response" do
      ...
      get "/manage/services/#{service.id}/edit", params: {}, headers: {}, env: { 'HTTP_HOST' => host_params[:host] }
      expect(response).to be_successful
    end
  end
    ...
    context "with valid parameters" do
      it "creates a new Service" do
        expect {
          ...
          post "/manage/services", params: { service: valid_attributes }, headers: {}, env: { 'HTTP_HOST' => host_params[:host] }
      ...
      it "redirects to the services list" do
        ...
        expect(response).to redirect_to("/manage/services")
      end
    end
  ...
  describe "PATCH /update" do
    ...
    context "with valid parameters" do
      it "updates the requested service" do
        ...
        patch "/manage/services/#{service.id}", params: { service: new_attributes }, headers: {}, env: { 'HTTP_HOST' => host_params[:host] }
        service.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested service" do
      ...
      expect {
        ...
        delete "/manage/services/#{service_to_delete.id}", headers: {}, env: { 'HTTP_HOST' => host_params[:host] }
      }.to change(Service, :count).by(-1)
    end

    it "redirects to the services list" do
      # delete url_for([:business_manager, service]), headers: {}, env: { 'HTTP_HOST' => host_params[:host] } # Reverted
      delete "/manage/services/#{service.id}", headers: {}, env: { 'HTTP_HOST' => host_params[:host] }
      # expect(response).to redirect_to(url_for([:business_manager, :services])) # Reverted
      expect(response).to redirect_to("/manage/services")
    end
  end
