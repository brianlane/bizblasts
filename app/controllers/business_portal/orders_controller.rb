module BusinessPortal
  class OrdersController < BusinessPortal::BaseController # Assuming you have a BusinessPortal::BaseController for common business-scoped logic
    ...
    # Ensure you have a BusinessPortal::BaseController like this (example):
    # module BusinessPortal
