...
class BusinessManager::SettingsController < BusinessManager::BaseController
  ...
  def edit_sidebar
    if current_user.user_sidebar_items.exists?
      ...
      # Add any missing default items (not yet customized)
  ...
  def update_sidebar
    ...
    ActiveRecord::Base.transaction do
      # Set all submitted items to visible: true/false based on param
      ...
      # For all default keys not submitted, set visible: false and preserve position if exists
